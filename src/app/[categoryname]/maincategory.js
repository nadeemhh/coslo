...
import slugifyurl from "../component/slugifyurl.js"
 ...
 function Subcategory() {
   ...
   let name = decodeURIComponent(searchParams.categoryname);  
...
console.log(name);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/category/landing/${name.replaceAll(' ','').toLowerCase()}`);
