...
function Login() {
    ...
    const handleLogin = (e) => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/seo/login`, {
          method: 'POST',
          headers: {
        ...
        localStorage.setItem('seotoken', data.token);
         window.location.href = '/seoadmin/managecategories';
          ...
          .catch((err) => {
            ...
            setError(err.message);
                  ...
                  useEffect(() => {
                            ...
                            if (localStorage.getItem('seotoken')) {
                              window.location.href = '/seoadmin/managecategories';
                          }
